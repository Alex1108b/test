...
<title>Guide Jour J - <?php echo mysql_result($sql_annonceur, 0, "nom_ann");?> - <?php echo mysql_result($sql_url_cat, 0, "nom_categorie");?> - Israël - Mariage Juif</title>
                ...
                <div class="container clearfix">
                    ...
                    <nav id="primary-menu" class="style-3">
                        ...
                        <ul>
                            ...
                            <!----Annuaire-->
                            <li><a href="annuaire-mariage-bar-mitzvah.html"><div>Annuaire France</div></a>
                            ...
                            <!--------End Annuaire--------->
                            <!----Annuaire-->
                            <li class="current"><a href="annuaire-mariage-bar-mitzvah-israel.html"><div>Annuaire Israël</div></a>
                            <div class="mega-menu-content col-2 clearfix">
                                <ul>
                                <?php
...
<span>DATE</span>&nbsp;<?php echo $date;?>
        ...
        <div class="container topmargin-lg clearfix">
                    ...
                    <div class="col_one_third">
                        ...
                        function call()
                        {
                        if (mysql_result($sql_annonceur, 0, "add_ann")!="") { ?>
                        <?php echo mysql_result($sql_annonceur, 0, "add_ann");?><br>
                        <?php } 

                        if (mysql_result($sql_annonceur, 0, "tel_ann")!="") { ?>

                        Téléphone : <a href="function call():;" class="button center" onclick="call()" id="hideTel" data-toggle="tooltip" data-placement="top" title="Appeler de la part de Jour J">APPELEZ</a><br>

                        <?php } 
                         if (mysql_result($sql_annonceur, 0, "port_ann")!="") { ?>
...
<?php } ?>
        ...
        <div class="clear"></div>
                ...
                <a href="annuaire-mariage-bar-mitzvah-israel.html" class="button button-full button-dark center tright bottommargin-lg">
                    <div class="container clearfix">
...
<div class="container clearfix">
					...
					<?php
					$sql_ann_isr2 = mysql_query("SELECT * FROM annonceurs WHERE id_categorie = ".$id_categorie." AND actif = 1 AND israel_ann = 1 ORDER by nom_ann");
					for ($i=0; $i<mysql_num_rows($sql_ann_isr2); $i++) {
					?>
                        <article id="portfolio-item-<?php echo ($i+1);?>" data-loader="include/ajax/portfolio-ajax-image.php" class="portfolio-item pf-media pf-icons">
                            ...
                            <div class="portfolio-desc">
                                <h3><a href="<?php echo $id_categorie;?>-<?php echo mysql_result($sql_url_cat, 0, "url_categorie");?>/<?php echo mysql_result($sql_ann_isr2, $i, "id_ann");?>-<?php echo mysql_result($sql_ann_isr2, $i, "url_ann");?>.html"><?php echo mysql_result($sql_ann_isr2, $i, "nom_ann");?></a></h3>
                            </div>
                            
                            <div class="portfolio-image">
                                <a href="<?php echo $id_categorie;?>-<?php echo mysql_result($sql_url_cat, 0, "url_categorie");?>/<?php echo mysql_result($sql_ann_isr2, $i, "id_ann");?>-<?php echo mysql_result($sql_ann_isr2, $i, "url_ann");?>.html">
                                    <img src="images/galerie/<?php echo mysql_result($sql_ann_isr2, $i, "pub_ann");?>" alt="Open Imagination">
                                </a>
                                <div class="portfolio-overlay">
                                    <a href="<?php echo $id_categorie;?>-<?php echo mysql_result($sql_url_cat, 0, "url_categorie");?>/<?php echo mysql_result($sql_ann_isr2, $i, "id_ann");?>-<?php echo mysql_result($sql_ann_isr2, $i, "url_ann");?>.html"><i class="icon-line-expand"></i></a>
                                </div>
                            </div>
